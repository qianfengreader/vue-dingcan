      ...
      <div>
        ...
        <el-dialog title="订单详情" :visible.sync="dialogFormVisible">
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="danger" @click="cancels()">取消订单</el-button>
...
<script>
  import axios from 'axios'
    export default {
      ...
      methods:{
        findAll:function () {
          axios.get("api/adimOrder/list").then(res=>{
        ...
        findByFoodId:function(){
          ...
          axios.post("api/adimOrder/detail",{orderId:this.ooorderId}).then(res=>{
            if (res.data.code == 200) {
        ...
        findAmount:function(){
          axios.post("api/adimOrder/findAmount",{orderId:this.ooorderId}).then(res=>{
            if (res.data.code == 200) {
        ...
        finishing:function () { //订单完成
          ...
          axios.post("api/adimOrder/finish",{id:this.ooorderId}).then(res=>{
            if (res.data.code == 200) {
              alert(res.data.msg)
              this.findAll()
            }else {
        ...
        cancels:function () {   //取消订单
          this.dialogFormVisible = false
          axios.post("api/adimOrder/cancel",{id:this.ooorderId}).then(res=>{
            if (res.data.code == 200) {
              alert(res.data.msg)
              this.findAll()
            }else {
        ...
        deleteorder:function (id) {//删除
          alert(id)
          axios.post("api/adimOrder/remove",{id:id}).then(res=>{
            if (res.data.code == 200) {
              alert(res.data.msg)
              this.findAll()
            }
