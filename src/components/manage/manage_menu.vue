  ...
  export default {
    ...
    methods:{
      findAll:function () {
        ...
        axios.post("api/weichat-menu/menu/findAll",this.param).then(res=>{
      ...
      searchFindAll:function(){
        axios.post("api/weichat-search/search/findAll").then(res=>{
          alert("正在ES查询");
          if (res.data.code==200){
      ...
      deleteMenuOne:function(id) {
        axios.post("api/weichat-menu/menu/deleteMenuOne?id="+id).then(res=>{
          //alert("删除ids")
          if (res.data.code == 200) {
            alert("删除成功");
            this.findAll()
      ...
      deleteMenu:function () {
          ...
          if (ids == null || ids.length == 0) {
            ...
            axios.post("api/weichat-menu/menu/deleteMenu",{ids:ids}).then(res=>{
              //alert("删除")
              if (res.data.code == 200) {
                alert("删除成功");
                this.findAll();
